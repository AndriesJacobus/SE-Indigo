...
\begin{itemize}
		...
		\item Server - the system depends on running on a remote server where the mobile application can authenticate and gain essential information to navigation.
...
\noindent \\A Directional Search is feature will be provided by the system and will contain the following functionality:
