...
\paragraph{Kung, D.C. (2013) Object-oriented software engineering: An agile unified methodology. New York: McGraw Hill Higher Education.}
\subsection{Overview}
...
\item Re-Routing\\A time-elapse of no more than 30 seconds is allowed when the system has to re-calculate the routes.
