...
The following section will focus on the quality requirements of the overall system at its
highest level of granularity. All the requirements defined, are for all components
of the system.
