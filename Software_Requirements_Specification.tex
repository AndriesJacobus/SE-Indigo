...
\begin{itemize}
	...
	\item Search bar to search for specific venues and places
	...
	\item Menu/options list which will show all options for the map such as displaying heat maps, recording goals and logging in of different types of users
